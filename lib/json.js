      ...
      case 'n':
        switch (this.state) {
          case 'value':
            ...
            break;
          case 'n':
            if (ch !== 'u') return this._error('Unexpected `' + ch + '`');
            this.state = 'nu';
            break;
          case 'nu':
            if (ch !== 'l') return this._error('Unexpected `' + ch + '`');
            this.state = 'nul';
            break;
          case 'nul':
            if (ch !== 'l') return this._error('Unexpected `' + ch + '`');
            ...
            break;
          case 'f':
            if (ch !== 'a') return this._error('Unexpected `' + ch + '`');
            this.state = 'fa';
            break;
          case 'fa':
            if (ch !== 'l') return this._error('Unexpected `' + ch + '`');
            ...
            break;
          case 'fal':
            if (ch !== 's') return this._error('Unexpected `' + ch + '`');
            this.state = 'fals';
            break;
          case 'fals':
            if (ch !== 'e') return this._error('Unexpected `' + ch + '`');
            this.emit('boolean', false);
            this.state = 'value';
            break;
          case 't':
            if (ch !== 'r') return this._error('Unexpected `' + ch + '`');
            this.state = 'tr';
            break;
          case 'tr':
            if (ch !== 'u') return this._error('Unexpected `' + ch + '`');
