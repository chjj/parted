...
parted.prototype._header = function(name, val) {
...
parted.middleware = function(options) {
  ...
  return function(req, res, next) {
    ...
    if (type && type.indexOf('multipart/form-data') === 0) {
      parted.handle(req, res, next, options);
    } else {
...
parted.handle = function(req, res, next, options) {
  var parser = new parted(req.headers['content-type'], options)
    , parts = {};
